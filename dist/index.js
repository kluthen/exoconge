...
const employee_1 = require("./lib/employee");
...
testCases.forEach(testCase => {
    const begin = new calendar_1.HDate();
    const end = new calendar_1.HDate();
    ...
    const [ok, halfDays, majoredDays] = (0, engine_1.ComputeNbHolidays)(emp, begin, end);
    console.log(`\n${testCase.label}:`);
